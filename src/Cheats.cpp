...
void Cheats::Init()
{
    ...
    sar_sr_hud.UniqueFor(SourceGame_Portal2Game);
    sar_sr_hud_x.UniqueFor(SourceGame_Portal2Game);
    sar_sr_hud_y.UniqueFor(SourceGame_Portal2Game);
    sar_sr_hud_font_color.UniqueFor(SourceGame_Portal2Game);
    sar_sr_hud_font_index.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_autostart.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_autostop.UniqueFor(SourceGame_Portal2Game);
    ...
    sar_speedrun_result.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_export.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_export_pb.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_import.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_category.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_categories.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_start.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_stop.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_split.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_pause.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_resume.UniqueFor(SourceGame_Portal2Game);
    sar_speedrun_reset.UniqueFor(SourceGame_Portal2Game);
