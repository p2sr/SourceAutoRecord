...
OFFSET_DEFAULT(GetGameData, 17, 18)
...
OFFSET_DEFAULT(CreateFrictionSnasphot, 80, 81)
OFFSET_DEFAULT(DestroyFrictionSnapshot, 81, 82)

// IPhysicsFrictionSnapshot
OFFSET_DEFAULT(IsValid, 1, 2)
OFFSET_DEFAULT(GetObject, 2, 3)
OFFSET_DEFAULT(GetContactPoint, 4, 5)
OFFSET_DEFAULT(GetSurfaceNormal, 5, 6)
OFFSET_DEFAULT(DeleteAllMarkedContacts, 11, 12)
OFFSET_DEFAULT(NextFrictionData, 12, 13)
