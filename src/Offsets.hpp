...
namespace Offsets {
	...
	extern int IsPaused;
	extern int DebugDrawPhysCollide;
	extern int Con_IsVisible;
	extern int GetLevelNameShort;
	extern int GetLightForPoint;
	...
	// CLaserCatcher
	extern int m_iPowerState;

	// CPropFloorButton
	extern int m_bButtonState;

	// CPortalLaser
	extern int m_bLaserOn;

	// CBaseProjector
	extern int m_bEnabled;

	// CTriggerPortalCleanser
	extern int m_bDisabled;

	// CPropTestChamberDoor
	extern int m_bIsOpen;

	// CPropButton
	extern int m_flGoalTime;

	// CTriggerCatapult
	extern int m_bUseThresholdCheck;
	extern int m_flLowerThreshold;
	extern int m_flUpperThreshold;
	extern int m_vecLaunchAngles;
	extern int m_flRefireDelay;

	// CPropWeightedCube
	extern int Cube_m_bActivated;
	extern int m_hLaser;

	// CNPC_Portal_FloorTurret
	extern int m_bIsFiring;
	...
	extern int FindMaterial;
	extern int CreateDebugMesh;
	extern int DestroyDebugMesh;
}  // namespace Offsets
