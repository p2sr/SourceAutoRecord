...
namespace Patterns
{
	...
	void LoadAll()
	{
		...
		AddTo("CheckJumpButton", "INFRA Build 6905", "55 8B EC 83 EC 0C 56 8B F1 8B 4E 04");
		...
		Create("SetPaused", "engine.dll", "Portal 2 Build 6879", "55 8B EC 83 EC 14 56 8B F1 83 7E 04 03");
	}
}