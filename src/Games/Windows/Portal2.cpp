...
void Portal2::LoadOffsets() {
	...
	GetPlayerViewOffset = 8;             // CGameMovement
	...
	m_iPortalLinkageGroupID = 385;       // CWeaponPortalgun
	...
	MsgFunc_SayText2 = 28;        // CBaseHudChat
	GetTextColorForClient = 33;   // CBaseHudChat
