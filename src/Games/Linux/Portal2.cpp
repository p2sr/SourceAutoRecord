...
void Portal2::LoadOffsets() {
	...
	OnGameOverlayActivated = 156;          // CSteam3Client
	IsAsleep = 3;                          // IPhysicsObject
	Wake = 25;                             // IPhysicsObject
	Sleep = 26;                            // IPhysicsObject
	...
	GetPlayerViewOffset = 9;             // CGameMovement
	...
	m_iPortalLinkageGroupID = 391;       // CWeaponPortalgun
	...
	StartTouch = 103;
	S_m_matrixThisToLinked = 1244;       // CPortal_Base2D
	...
	C_m_matrixThisToLinked = 3492;  // CPortal_Base2D
	C_m_vPortalForward = 4104;      // CPortal_Base2D
