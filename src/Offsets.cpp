...
namespace Offsets {
	...
	int m_lifeState;
	int C_m_hPortalEnvironment;
	int S_m_hPortalEnvironment;
	int PlayerRunCommand;
	int S_m_nPlayerCond;
	int C_m_nPlayerCond;
	...
	int C_m_ptOrigin;
	int S_m_ptOrigin;
	int C_m_vPortalForward;
	int S_m_vForward;
	int C_m_matrixThisToLinked;
	int S_m_matrixThisToLinked;
	int C_m_hLinkedPortal;
	...
	int NUM_ENT_ENTRIES;
	int ENT_ENTRY_MASK;
	unsigned INVALID_EHANDLE_INDEX;
